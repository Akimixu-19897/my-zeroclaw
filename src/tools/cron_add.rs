    ...
    fn parameters_schema(&self) -> serde_json::Value {
        json!({
            ...
            "properties": {
                ...
                "delivery": {
                    "type": "object",
                    "description": "Delivery config to send job output to a channel. Example: {\"mode\":\"announce\",\"channel\":\"wecom\",\"account\":\"ops\",\"to\":\"user:alice\"}",
                    "properties": {
                        ...
                        "to": { "type": "string", "description": "Target: Discord channel ID, Telegram chat ID, Slack channel, WeCom user:<userid> or group:<chatid>, etc." },
