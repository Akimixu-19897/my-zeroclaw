...
impl Tool for CronAddTool {
    ...
    fn description(&self) -> &str {
        "Create a scheduled cron job (shell or agent) with cron/at/every schedules. \
         ...
         To deliver output to a channel (Discord, Telegram, Slack, Mattermost, WeCom), set \
    ...
    fn parameters_schema(&self) -> serde_json::Value {
        json!({
            ...
            "properties": {
                ...
                "delivery": {
                    "type": "object",
                    "description": "Delivery config to send job output to a channel. Example: {\"mode\":\"announce\",\"channel\":\"wecom\",\"account\":\"ops\",\"to\":\"chat:chat-123\"}",
                    "properties": {
                        "mode": { "type": "string", "enum": ["none", "announce"], "description": "Set to 'announce' to deliver output to a channel" },
                        "channel": { "type": "string", "enum": ["telegram", "discord", "slack", "mattermost", "feishu", "lark", "wecom"], "description": "Channel type to deliver to" },
                        "account": { "type": "string", "description": "Optional named account for multi-account channels such as WeCom" },
                        "to": { "type": "string", "description": "Target: Discord channel ID, Telegram chat ID, Slack channel, WeCom chat:<chatid> or group:<chatid>, etc." },
