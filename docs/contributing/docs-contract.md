...
- root READMEs: `README.md`, `README.en.md`
- docs hubs: `docs/README.md`, `docs/README.en.md`
...
- Keep entry-point parity across Chinese and English when changing navigation architecture.
- If a change touches docs IA, runtime-contract references, or user-facing wording in shared docs, update both retained entry-point locales in the same PR:
